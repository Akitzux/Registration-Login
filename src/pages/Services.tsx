  ...
  return (
    ...
    >
      ...
      <main className="flex flex-1 flex-col items-center justify-center py-24">
        <h2 className="text-3xl font-bold text-primary drop-shadow mb-4">Our Services</h2>
        <p className="text-lg text-black/80 max-w-xl text-center">
          Here you can list and describe the services you provide. Edit this page for more details!
        </p>
      </main>
    </div>
  );
